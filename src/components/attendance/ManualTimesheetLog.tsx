              ...
              {loading ? (
                ...
                paginated.map((r, idx) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 font-semibold text-slate-900">{resolveRowName(r)}</td>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-5 py-4">
              <h3 id="manual-timesheet-detail-title" className="text-2xl font-bold text-slate-900">
                Manual Time Records
              </h3>
              <button
                type="button"
